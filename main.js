const tools = [
  {id:'virtual-baustellenplaner',title:'Virtual Baustellenplaner',text:'Hallen, Assets und reale Baustellenplanung einschließlich praktischer Kabeltrassen-Workflows planen.',href:'https://drhoschi.github.io/virtual-baustellenplaner/',authority:'EXTERNAL PRODUCT',role:'PLANNING / SITE WORKFLOW',detail:'Produkt-Authority: DrHoschi/virtual-baustellenplaner',areas:['industry']},
  {id:'cybermotion-3d',title:'CyberMotion 3D Web Designer',text:'Technische 3D-Szenen und Engineering-Strukturen im eigenständigen CyberMotion-Designer bearbeiten.',href:'https://github.com/DrHoschi/CM3D',authority:'EXTERNAL PRODUCT',role:'3D DESIGN / ENGINEERING',detail:'Produkt-Authority: DrHoschi/CM3D',areas:['industry']},
